...
/// <summary>Stable names for the extended tools exposed by <see cref="FileContextProvider" />.</summary>
public static class FileContextToolNames
{
    public const string CreateText = "file_context_create_text";
    ...
    public const string ExportMarkdownGraph = "file_context_markdown_graph_export";
}
